...
// bool getMaxContour(const std::vector<std::vector<cv::Point>>& contours, int &maxAreaIdx, float& maxContourArea, const float &product_diameter, const float &product_diameter_offset, const int &resize_scale);
